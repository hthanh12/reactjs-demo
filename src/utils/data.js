const MEMBERS = [
  {
    ...
    name: "chị Hằng",
    avatar_url:
      "https://lh3.googleusercontent.com/a-/AOh14GgvoISBkesuPBIUsfEFh1jwt7uYOIP59qqC3SQL=s272-p-k-rw-no",
  },
  {
    id: 2,
    name: "chị Thư",
    avatar_url:
      "https://lh3.googleusercontent.com/a-/AOh14Giif3FZvInso5KGgKbj2yoynkO3cKXwH8uiGvip=s272-p-k-rw-no",
  },
];
...
const TEAM_MEMBER = [
  {
    id: 1,
    name: "Thế Tín",
    avt: "https://rocket20.lubrytics.com/avatar/phanthetin",
  },
  {
    id: 2,
    name: "Minh Hoài",
    avt: "https://rocket20.lubrytics.com/avatar/hoai.nguyenminh356",
  },
  {
    id: 3,
    name: "Hoàng Thành",
    avt: "https://rocket20.lubrytics.com/avatar/hoangthanh",
  },
];
const SERVERS = [
  {
    id: 1,
    name: "DEV",
    link: process.env.REACT_APP_LINK_IWS_DEV,
    link_wms: process.env.REACT_APP_LINK_WMS_DEV,
    link_sync: process.env.REACT_APP_LINK_SYNC_DEV,
  },
